...
import style from './RecordingTrack.css';

class RecordingTrack extends Component {
    render() {
        return (
            <div className={style.RecordingTrack} title={"Записать трек в плейлист"}>
                <svg viewBox={"0 0 1000 1000"} className={style.svg_icon}>
